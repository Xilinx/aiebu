...
class ELFWriter(WriterBase):
    ...
    def __init__(self, filename, symbols, numpages):
        ...
        self.symbol_kind2r_info = {
            Symbol.SymbolKind.UC_DMA_REMOTE_PTR_SYMBOL_KIND: pylibelf.elf.R_M32R_32_RELA,
            Symbol.SymbolKind.SCALAR_32BIT_KIND: pylibelf.elf.R_M32R_32_RELA,
            Symbol.SymbolKind.SHIM_DMA_BASE_ADDR_SYMBOL_KIND: pylibelf.elf.R_M32R_NUM,
            Symbol.SymbolKind.UNKNOWN_SYMBOL_KIND: pylibelf.elf.R_M32R_NONE
        }
